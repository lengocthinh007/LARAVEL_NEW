...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			><a href="{{asset('admin/product')}}"><em class="fa fa-bar-chart">&nbsp;</em> Sản Phẩm</a></li>
			<li
			class="{{\Request::route()->getName()=='admin.transaction.index'?'active':''}}"
			><a href="{{asset('admin/transaction')}}"><em class="fa fa-toggle-off">&nbsp;</em> Đơn Hàng</a></li>
			<li
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					<li><a class="" href="{{asset('admin/category')}}">
						<span class="fa fa-arrow-right">&nbsp;</span> Danh Mục
					</a></li>
					<li><a class="" href="#">
